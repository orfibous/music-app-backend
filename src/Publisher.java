...
class Publisher extends Node{
    ...
    public static void main(String[] args) throws IOException, InvalidDataException, UnsupportedTagException, ClassNotFoundException, InterruptedException {
        ...
        Publisher p = new Publisher(Globals.publisher_1_datapath);

        Broker1 b = new Broker1(Globals.broker_1_ip, Globals.publisher_accept_port1);
        p.connect(b);
    ...
    public static void fillArtistList() {
    ...
    public static void fillArtistSongList() {
    ...
    void push(MusicFile m) throws IOException, InvalidDataException, UnsupportedTagException, ClassNotFoundException {
        ...
        this.oocs.flush();
        this.oocs.reset();
        System.out.println("Publisher_CLIENT" + InetAddress.getByName(Globals.publisher_1_ip) + ":" + this.cs.getLocalPort() + " -> Song sent successfully!");
        listen();
    }
    ...
    static void printArtistSongList() {
        ...
        for (ArtistName artistName : artistList) {
            System.out.println("--------------Library of " + artistName.getArtist() + "--------------");
